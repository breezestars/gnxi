...
// Acl_AclSet_AclEntry_Transport_DestinationPort_Union_E_OpenconfigPacketMatch_Transport_DestinationPort is used when /openconfig-acl/acl/acl-sets/acl-set/acl-entries/acl-entry/transport/config/destination-port
...
// Is_Acl_AclSet_AclEntry_Transport_DestinationPort_Union ensures that Acl_AclSet_AclEntry_Transport_DestinationPort_Union_E_OpenconfigPacketMatch_Transport_DestinationPort
...
func (t *Acl_AclSet_AclEntry_Transport) To_Acl_AclSet_AclEntry_Transport_DestinationPort_Union(i interface{}) (Acl_AclSet_AclEntry_Transport_DestinationPort_Union, error) {
	...
	case E_OpenconfigPacketMatch_Transport_DestinationPort:
		return &Acl_AclSet_AclEntry_Transport_DestinationPort_Union_E_OpenconfigPacketMatch_Transport_DestinationPort{v}, nil
	case string:
	...
	default:
		return nil, fmt.Errorf("cannot convert %v to Acl_AclSet_AclEntry_Transport_DestinationPort_Union, unknown union type, got: %T, want any of [E_OpenconfigPacketMatch_Transport_DestinationPort, string, uint16]", i, i)
	}
}
...
// Acl_AclSet_AclEntry_Transport_SourcePort_Union_E_OpenconfigPacketMatch_Transport_SourcePort is used when /openconfig-acl/acl/acl-sets/acl-set/acl-entries/acl-entry/transport/config/source-port
...
// Is_Acl_AclSet_AclEntry_Transport_SourcePort_Union ensures that Acl_AclSet_AclEntry_Transport_SourcePort_Union_E_OpenconfigPacketMatch_Transport_SourcePort
...
func (t *Acl_AclSet_AclEntry_Transport) To_Acl_AclSet_AclEntry_Transport_SourcePort_Union(i interface{}) (Acl_AclSet_AclEntry_Transport_SourcePort_Union, error) {
	...
	case E_OpenconfigPacketMatch_Transport_SourcePort:
		return &Acl_AclSet_AclEntry_Transport_SourcePort_Union_E_OpenconfigPacketMatch_Transport_SourcePort{v}, nil
	case string:
	...
	default:
		return nil, fmt.Errorf("cannot convert %v to Acl_AclSet_AclEntry_Transport_SourcePort_Union, unknown union type, got: %T, want any of [E_OpenconfigPacketMatch_Transport_SourcePort, string, uint16]", i, i)
	}
}
...
// Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel is used when /openconfig-mpls/mpls/signaling-protocols/segment-routing/aggregate-sid-counters/aggregate-sid-counter/state/mpls-label
// is to be set to a E_OpenconfigSegmentRouting_SidCounter_MplsLabel value.
type Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel struct {
	E_OpenconfigSegmentRouting_SidCounter_MplsLabel	E_OpenconfigSegmentRouting_SidCounter_MplsLabel
}

// Is_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union ensures that Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel
// implements the Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union interface.
func (*Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel) Is_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union() {}
...
func (t *Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter) To_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union(i interface{}) (Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union, error) {
	switch v := i.(type) {
	case E_OpenconfigSegmentRouting_SidCounter_MplsLabel:
		return &Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel{v}, nil
	case uint32:
		return &Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union, unknown union type, got: %T, want any of [E_OpenconfigSegmentRouting_SidCounter_MplsLabel, uint32]", i, i)
	}
}
...
// Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel is used when /openconfig-mpls/mpls/signaling-protocols/segment-routing/interfaces/interface/sid-counters/sid-counter/state/mpls-label
// is to be set to a E_OpenconfigSegmentRouting_SidCounter_MplsLabel value.
type Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel struct {
	E_OpenconfigSegmentRouting_SidCounter_MplsLabel	E_OpenconfigSegmentRouting_SidCounter_MplsLabel
}

// Is_Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union ensures that Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel
// implements the Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union interface.
func (*Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel) Is_Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union() {}
...
func (t *Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter) To_Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union(i interface{}) (Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union, error) {
	switch v := i.(type) {
	case E_OpenconfigSegmentRouting_SidCounter_MplsLabel:
		return &Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel{v}, nil
	case uint32:
		return &Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union, unknown union type, got: %T, want any of [E_OpenconfigSegmentRouting_SidCounter_MplsLabel, uint32]", i, i)
	}
}
...
// NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel is used when /openconfig-network-instance/network-instances/network-instance/mpls/signaling-protocols/segment-routing/aggregate-sid-counters/aggregate-sid-counter/state/mpls-label
// is to be set to a E_OpenconfigSegmentRouting_SidCounter_MplsLabel value.
type NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel struct {
	E_OpenconfigSegmentRouting_SidCounter_MplsLabel	E_OpenconfigSegmentRouting_SidCounter_MplsLabel
}

// Is_NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union ensures that NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel
// implements the NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union interface.
func (*NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel) Is_NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union() {}
...
func (t *NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter) To_NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union(i interface{}) (NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union, error) {
	switch v := i.(type) {
	case E_OpenconfigSegmentRouting_SidCounter_MplsLabel:
		return &NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel{v}, nil
	case uint32:
		return &NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_AggregateSidCounter_MplsLabel_Union, unknown union type, got: %T, want any of [E_OpenconfigSegmentRouting_SidCounter_MplsLabel, uint32]", i, i)
	}
}
...
// Is_NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union ensures that NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel
...
func (t *NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter) To_NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union(i interface{}) (NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union, error) {
	switch v := i.(type) {
	case E_OpenconfigSegmentRouting_SidCounter_MplsLabel:
		return &NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union_E_OpenconfigSegmentRouting_SidCounter_MplsLabel{v}, nil
	case uint32:
		return &NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Mpls_SignalingProtocols_SegmentRouting_Interface_SidCounter_MplsLabel_Union, unknown union type, got: %T, want any of [E_OpenconfigSegmentRouting_SidCounter_MplsLabel, uint32]", i, i)
	}
}
